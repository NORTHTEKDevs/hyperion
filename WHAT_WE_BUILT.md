...
| **2D ARC-AGI** | Full-blown 2D abstract reasoning puzzles | **15.50% training, 3.25% evaluation** | LLM-based state of the art: ~55-60%. Hodel-style hand-coded DSLs (~150 primitives): 30-40%. Human: ~85%. |
